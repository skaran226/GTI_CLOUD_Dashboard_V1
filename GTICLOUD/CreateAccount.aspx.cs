...
namespace GTICLOUD
{
    public partial class CreateAccount : System.Web.UI.Page
    {
        ...
        public static string query = "insert into registration (gti_user_name,email,category,password,created,updated) values (@username,@email,@category,@password,@created,@updated)";
